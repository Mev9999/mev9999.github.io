...
export function refreshSite(d,file){
 ...
 if(!d.querySelector('link[href^="scripts/site-refresh.css"]')){const css=el('link');css.rel='stylesheet';css.href='scripts/site-refresh.css?v=20260917-header-icons-v2';d.head.append(css);}
 d.querySelector('link[href^="scripts/site-refresh.css"]') .href='scripts/site-refresh.css?v=20260917-header-icons-v2';
