...
module.exports=function(root,source,out){
 ...
 for(const lang of ['de','en','bs']){
  ...
  for(const href of ['../scripts/accessibility-fixes.css','gewinnspiel-scoped.css?v=20260925-service-icons']){const el=doc.createElement('link');el.rel='stylesheet';el.href=href;doc.head.append(el);}
